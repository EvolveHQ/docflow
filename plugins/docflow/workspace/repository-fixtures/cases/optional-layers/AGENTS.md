...
2. `.docflow/CONVENTIONS.md` — authoring rules, ADR status semantics, the git
   contract.

3. `.docflow/plan/README.md` — how the work queue is used.
4. The newest `.docflow/plan/done/` entries and
   `git log --first-parent --oneline -n 20` — the shipped-work record.
5. `.docflow/INDEX.md` — the ADR catalogue: an ADR's filename and its dependency
...
7. The queue item you are about to work, `.docflow/plan/todo/NNNN-<slug>.md`, and
