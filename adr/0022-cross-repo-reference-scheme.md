...
| 2026-06-23 | r5 | Eugenio Minardi | Post-verification tightening: documented the member-side two-hop — a member repo holds no index, so it reaches federation-index.md via its own federation.md Home pointer before resolving — surfaced by the smoke test. Stays Implemented. |
