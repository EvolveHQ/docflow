...
Controller message `msg_4bacc53cf2c2` approves this bounded repair after the
...
readiness reports. Add a shared `workspace/guides/external-returns.md`, link it
from `workspace-coordinate/SKILL.md`, the guides index and the six native guides.
