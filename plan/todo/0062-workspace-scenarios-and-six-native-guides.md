...
independent C12 `366a73a3b254ce6c6ab38c3e327eb6f1cb246c68` is
read-only preparation evidence, not combined acceptance. Record all eighteen
scenario assertions and six guides with native, simulated and unrun effects
distinguished. Item 0063 permits operator-handoff preparation only in this
dispatch; actual operator acceptance remains outstanding. No Clarity or
parent-document writes are authorised.
