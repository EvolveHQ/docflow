...
| 2026-06-02 | pending | main | plan 0005 / ADR 0013 | Assessment Step 0.5 added to new-adr/new-plan/add-convention/brainstorm; verify green; ADR 0013 stays Accepted (0006 pending). |
| 2026-06-02 | pending | main | plan 0006 / ADR 0013 | agent-wave Step 0.5 + merge-strategy question; verify green; ADR 0013 → Implemented. Queue empty. |
